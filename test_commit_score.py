...
class TestCommitScore(TestCase):
    ...
    def test_commit_score_ones(self, mock_input):
        ...
        expected_return = {'aces': 5, 'twos': -1, 'threes': -1, 'fours': -1, 'fives': -1, 'sixes': -1,
                           '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                           'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
    ...
    def test_commit_score_twos(self, mock_input):
        ...
        argument2 = {'aces': -1, 'twos': -1, 'threes': -1, 'fours': -1, 'fives': -1, 'sixes': -1,
                     '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                     'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        expected_return = {'aces': -1, 'twos': 6, 'threes': -1, 'fours': -1, 'fives': -1, 'sixes': -1,
                           '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                           'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        actual_return = commit_score(argument1, argument2)
    ...
    def test_commit_score_threes(self, mock_input):
        ...
        argument2 = {'aces': -1, 'twos': -1, 'threes': -1, 'fours': -1, 'fives': -1, 'sixes': -1,
                     '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                     'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        expected_return = {'aces': -1, 'twos': -1, 'threes': 9, 'fours': -1, 'fives': -1, 'sixes': -1,
                           '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                           'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        actual_return = commit_score(argument1, argument2)
    ...
    def test_commit_score_fours(self, mock_input):
        ...
        argument2 = {'aces': -1, 'twos': -1, 'threes': -1, 'fours': -1, 'fives': -1, 'sixes': -1,
                     '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                     'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        expected_return = {'aces': -1, 'twos': -1, 'threes': -1, 'fours': 16, 'fives': -1, 'sixes': -1,
                           '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                           'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        actual_return = commit_score(argument1, argument2)
    ...
    def test_commit_score_fives(self, mock_input):
        ...
        argument2 = {'aces': -1, 'twos': -1, 'threes': -1, 'fours': -1, 'fives': -1, 'sixes': -1,
                     '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                     'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        expected_return = {'aces': -1, 'twos': -1, 'threes': -1, 'fours': -1, 'fives': 10, 'sixes': -1,
                           '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                           'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        actual_return = commit_score(argument1, argument2)
    ...
    def test_commit_score_sixes(self, mock_input):
        ...
        argument2 = {'aces': -1, 'twos': -1, 'threes': -1, 'fours': -1, 'fives': -1, 'sixes': -1,
                     '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                     'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        expected_return = {'aces': -1, 'twos': -1, 'threes': -1, 'fours': -1, 'fives': -1, 'sixes': 24,
                           '3 of a kind': -1, '4 of a kind': -1, 'full house': -1, 'small straight': -1,
                           'large straight': -1, 'yahtzee': -1, 'chance': -1, 'yahtzee bonus': 0}
        actual_return = commit_score(argument1, argument2)
        self.assertEqual(expected_return, actual_return, "Player wishes to score fives.")
